...
(1, 'Product A2', 1, 0.00), -- Exemplo de valor de item, mas a Order.calculateTotalValue é mais robusta
(2, 'Product B1', 1, 250.00),
(3, 'Product C1', 3, 25.17), -- 3 * 25.17 = 75.51, arredondado para 75.50 no totalValue
